...
namespace App.Areas.Seller.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(E_CommerceContext context, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var query = from product in _context.Products
                        ...
                        where product.IdAcc == valueIdAcc && product.StatusPro == 1
                        select new
                        {
                            Product = product,
                            Category = category,
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var query = from product in _context.Products
                        ...
                        where product.IdAcc == valueIdAcc && product.StatusPro == 1 && product.IdPro == id
                        select new
                        {
                            Product = product,
        ...
        // GET: Seller/Products/Details
        //[HttpGet("/seller/product/ProImage/")]
        //public async Task<IActionResult> ProImage()
        //{
        //	string id = HttpContext.Session.GetString("IDPro");
        ...
        //		var fileName = DateTime.Now.ToString("yyyymmddMMss") + "_" + Path.GetFileName(p.imgFiles.FileName);
        ...
        public async Task<IActionResult> EditItems(string id)
        {
            ...
            var productItems = await _context.ProductItems.FirstOrDefaultAsync(p => p.IdProItem == id && p.StatusProItem == 1);
